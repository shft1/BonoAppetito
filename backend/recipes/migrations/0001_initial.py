# Generated by Django 3.2.16 on 2024-04-18 16:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('recipes', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='users_shopping_cart', to='recipes.recipes')),
                ('users', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipes_shopping_cart', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='recipes',
            name='shopping_cart',
            field=models.ManyToManyField(related_name='recipe_in_shopping_cart', through='recipes.Shopping_Cart', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='recipes',
            name='tags',
